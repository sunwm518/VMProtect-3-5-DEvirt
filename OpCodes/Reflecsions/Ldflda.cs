...
namespace Vika_Anti_VMP_OOP_3._5_Based.Reflecsions
{
    class Ldflda : IOpCode
    {
        ...
        public override bool is_opcode(MethodDef md)
        {
            ...
            if (md.Body.Instructions[20].Operand.ToString().Contains("FieldInfo")) return true; else return false;
        ...
        public override Vika_Instruction restore_instruction(BinaryReader read, Vika_Method md, Vika_Context vika)
        {
            ...
            return new Vika_Instruction(OpCodes.Ldflda, (IField)vika.module.ResolveToken(Convert.ToUInt32(token)));
        }
