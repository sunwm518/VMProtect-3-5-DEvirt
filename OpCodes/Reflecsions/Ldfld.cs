...
namespace Vika_Anti_VMP_OOP_3._5_Based.Reflecsions
{
    class Ldfld : IOpCode
    {
        ...
        public override bool is_opcode(MethodDef md)
        {
            ...
            if (md.Body.Instructions[21].Operand.ToString().Contains("FieldInfo")) return true; else return false;
        ...
        public override Vika_Instruction restore_instruction(BinaryReader read, Vika_Method md, Vika_Context vika)
        {
            ...
            return new Vika_Instruction(OpCodes.Ldfld, (IField)vika.module.ResolveToken(Convert.ToUInt32(token)));
        }
