...
namespace Vika_Anti_VMP_OOP_3._5_Based.Reflecsions
{
    class Ldftn : IOpCode
    {
        ...
        public override bool is_opcode(MethodDef md)
        {
            ...
            if (md.Body.Instructions[5].Operand.ToString().Contains("MethodBase"))
            {
                return true;
            }
            else return false;
        ...
        public override Vika_Instruction restore_instruction(BinaryReader read, Vika_Method md, Vika_Context vika)
        {
            ...
            return new Vika_Instruction(OpCodes.Ldftn,(IMethodDefOrRef)vika.module.ResolveToken(Convert.ToUInt32( token)));
        }
